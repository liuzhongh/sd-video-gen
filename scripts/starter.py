                ...
                with gr.Tabs(elem_id="videogen_source_video"):
                    with gr.TabItem('Step One'):
                        with gr.Column(variant='panel'):
                            ...
                            output_video_quality = gr.Slider(label="Video Quality", info="Quality used for the output video", step=1,
                    ...
                    with gr.TabItem('Step Three'):
                        with gr.Column(variant='panel'):
                            ...
                            submit = gr.Button("Generate", elem_id="video_generate", variant="secondary")
